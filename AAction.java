/**
 * Classe abstraite représentant une action qu'une entité peut effectuer en combat.
...
public abstract class AAction {
     ...
     * @param cooldownDuration Le nombre de tours à attendre avant de pouvoir la réutiliser.
     */
