...
import towergame.controller.BattleController;
...
class BattleControllerEffectsTest {
    ...
    static class TestableController extends BattleController {
        ...
        @Override
        // Ajout de l'annotation @Override
        void showAlert(String title, String content) { // La méthode est maintenant package-private dans le parent
